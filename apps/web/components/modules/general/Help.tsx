  ...
  return (
    <div className="h-full overflow-y-auto bg-bg p-6 sm:p-10 text-text-primary text-base">
      <div className="max-w-3xl space-y-12">
        ...
        {/* How to Use Section */}        
        <section className="space-y-10">
          <h2 className="text-2xl font-bold uppercase">How to Use</h2>

          <div
            className="flex items-center gap-3 px-4 py-2 bg-priority-med/10 border border-priority-med/20 rounded-md  "
          >
            <Info className="w-4 h-4 text-priority-med flex-shrink-0" />
            <p>
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-4">
              ...
              <p className=" ">You can create or open a plan <strong>anywhere on your machine</strong>:</p>
            ...
            <div className="space-y-4">
              ...
              <ol className="list-decimal pl-5   space-y-2">
                <li>
                  ...
                  <img src="https://raw.githubusercontent.com/manhowong/plan-inplace/refs/heads/main/assets/images/screenshots/active-tasks.png" alt="Active Tasks" className="rounded-md mt-2 w-[30%]" />
                </li>
                <li>Add a task via 3 options:
                  ...
                  <img src="https://raw.githubusercontent.com/manhowong/plan-inplace/refs/heads/main/assets/images/screenshots/add-task.png" alt="Add task options" className="rounded-md mt-2 w-[70%]" />
                </li>
              </ol>
            </div>
            ...
            <div className="space-y-2">
              ...
              <img src="https://raw.githubusercontent.com/manhowong/plan-inplace/refs/heads/main/assets/images/screenshots/toggle-view.png" alt="Toggle view" className="rounded-md w-[25%]" />
